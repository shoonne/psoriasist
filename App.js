...
export default class App extends React.Component {
  render() {
    return <AppContainer />;
        ...
        {/* <TouchableOpacity onPress={() => this.props.navigation.navigate('MyTreatment')}>
          <View style={styles.buttonView}>
          <Text style={styles.buttonText}>MIN BEHANDLING</Text>
          </View>
        </TouchableOpacity>
        <View style={{ width: deviceWidth, padding:10}}/>

        <TouchableOpacity onPress={() => this.props.navigation.navigate('SkinAndNailSelfie')}>
          <View style={styles.buttonView}>
          <Text style={styles.buttonText}>HUD OCH NAGELBILDER</Text>
          </View>
        </TouchableOpacity>
        <View style={{ width: deviceWidth, padding:10}}/>
        ...
        <TouchableOpacity  onPress={() => this.props.navigation.navigate('Appointments')}>
          <View style={styles.buttonView}>
          <Text style={styles.buttonText}>LÄKARBESÖK</Text>
          </View>
        </TouchableOpacity>
        <View style={{ width: deviceWidth, padding:10}}/>


        <TouchableOpacity onPress={() => this.props.navigation.navigate('Psoriasis')}>
          <View style={styles.buttonView}>
          <Text style={styles.buttonText}>VAD ÄR PSORIASIS?</Text>
          </View>
        </TouchableOpacity> */}

        {/* <Button
          title="Go to Details"
          onPress={() => this.props.navigation.navigate('MyTreatment')}
        />
